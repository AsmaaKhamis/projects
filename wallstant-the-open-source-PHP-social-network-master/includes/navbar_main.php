...
<nav class="navbar navbar-inverse" style="position:fixed;top:0;right:0;left:0;z-index: 2; background-color:#12DDCF;">
    <div class="container-fluid" style="width: 1040px;">
        <div class="navbar-header" style="float: <?php echo lang('float'); ?>;">
            ...
            <a class="navbar-brand" href="<?php echo $dircheckPath; ?>home">Just4U</a>
        </div>
