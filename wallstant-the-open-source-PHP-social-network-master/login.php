...
<head>
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">Just4U</a>
        ...
        <div align="center">
            <div class="login_signup_box2" style="text-align:<? echo lang('textAlign'); ?>">
                <h3 align="center"><? echo lang('login'); ?></h3><br/>
            ...
            <div style="background: #fff; border-radius: 3px; max-width: 420px; padding: 15px; margin:auto;margin-top: 15px;color:red;" align="center">
